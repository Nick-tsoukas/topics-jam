<template>
    <section style="position: relative" class="container mx-auto s" id="topics">
      <!-- categories -->
      <div class="grid grid-cols-2 items-center md:flex flex-row justify-items-center">
        <div class="h-64 w-96 text-xl flex justify-center m-2 theology hover:z-10
            transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-125">
          <h2 class="heading_font text-white pt-5">ASTROLOGY</h2>
        ...
        <div class="h-96 w-56 text-xl flex justify-center m-2 saint_hood hover:z-10
            transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-125">
          <h2 class="heading_font text-white pt-5">MYTHOLOGY</h2>
          <!-- <img src="../static/images/icons/juno.png" style="position: absolute; bottom: -90px; height: 56px" alt=""> -->
        </div>
      </div>
    </section>
</template>
